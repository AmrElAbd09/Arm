...
//#define SYSTICK_STCTRL										(*((volatile SYSTICK_STCTRL_Tag*)(CORTEXM4_PERI_BASE_ADDRESS+0x010)))
#define SYSTICK_STCTRL									  	(*((volatile uint32*)(CORTEXM4_PERI_BASE_ADDRESS+0x010)))
