...
{ 
	...
	Portptr = (volatile uint32*)GPIO_PORTF_BASE_ADDRESS;
//	SET_BIT(*(volatile uint32*)((volatile uint8*)Portptr +   GPIO_GPIOICR_OFFSET),   PIN4);
//	SET_BIT(*(volatile uint32*)((volatile uint8*)Portptr +   GPIO_GPIOIM_OFFSET ),   PIN4);
//	CLEAR_BIT(*(volatile uint32*)((volatile uint8*)Portptr + GPIO_GPIOIEV_OFFSET),   PIN4)  ;
	SET_BIT(*(volatile uint32*)((volatile uint8*)Portptr +   GPIO_GPIOICR_OFFSET),   PIN0);
	SET_BIT(*(volatile uint32*)((volatile uint8*)Portptr +   GPIO_GPIOIM_OFFSET ),   PIN0);
	CLEAR_BIT(*(volatile uint32*)((volatile uint8*)Portptr + GPIO_GPIOIEV_OFFSET),   PIN0)  ;
